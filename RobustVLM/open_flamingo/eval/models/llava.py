...
class EvalModelLLAVA(BaseEvalModel):
    ...
    def __init__(self, model_args):
        ...
        # default to float16, no need to specify dtype
        self.tokenizer, self.model, self.image_processor, context_len = load_pretrained_model(model_path, model_args.get("model_base", None), model_name=model_args.get("model_name", "'llava-v1.5-7b'"),
